...
export default function GuestDashboard({ guest }) {
  ...
  return (
    <div className="p-6 animate-fade">
      <h1 className="text-2xl font-bold mb-4">Hi {firestoreGuest.name}! 👋</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="border p-4 rounded-xl shadow hover:shadow-md transition duration-300">
          ...
          <p>{firestoreGuest.room}<br />Arrival: {firestoreGuest.arrival}<br />Departure: {firestoreGuest.departure}</p>
        </div>
